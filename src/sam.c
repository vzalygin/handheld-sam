...
unsigned char stress[256] NOINITMEM;         // numbers from 0 to 8
...
int Parser1() {
    ...
    while (1) {
        ...
        // NOW sign1 = FIRST CHARACTER OF PHONEME, AND sign2 = SECOND CHARACTER
        // OF PHONEME
    ...
    pos41095:
        ...
        // NO MATCH, TRY TO MATCH ON FIRST CHARACTER TO WILDCARD NAMES (ENDING
        // WITH '*')
...
//       <VOWEL> L -> <VOWEL> LX
//       G S -> G Z
//       K <VOWEL OR DIPHTONG NOT ENDING WITH IY> -> KX <VOWEL OR DIPHTONG NOT
//       ENDING WITH IY> G <VOWEL OR DIPHTONG NOT ENDING WITH IY> -> GX <VOWEL
//       OR DIPHTONG NOT ENDING WITH IY> S P -> S B S T -> S D S K -> S G S KX
...
void Parser2() {
    ...
    while (1) {
        ...
        // RULE:
        //       <DIPHTONG ENDING WITH WX> -> <DIPHTONG ENDING WITH WX> WX
        //       <DIPHTONG NOT ENDING WITH WX> -> <DIPHTONG NOT ENDING WITH WX>
        //       YX
        // Example: OIL, COW
        ...
        if (debug)
            if (B == 21)
                printf(
                    "RULE: insert YX following diphtong ending in IY sound\n");
    ...
    pos41466:
        ...
        // Perform insert. Note code below may jump up here with different
        // values
    ...
    pos41611:
        ...
        if (B == 24)  // 'L'
        {
            ...
            // Prior phoneme has VOWEL flag set, so change L to LX and move to
            // next phoneme
        ...
        // RULE:
        //             K <VOWEL OR DIPHTONG NOT ENDING WITH IY> -> KX <VOWEL OR
        ...
        if (B == 72)  // 'K'
        {
            ...
            // RULE:
            //             G <VOWEL OR DIPHTONG NOT ENDING WITH IY> -> GX <VOWEL
...
//         both to 1/2 + 1 <LIQUID CONSONANT> <DIPHTONG> - decrease by 2
...
void AdjustLengths() {
    ...
    while (1) {
        ...
        if (B != 0) {
            ...
            // <VOWEL> <WH, R*, L*, W*, Y*, M*, N*, NX, DX, Q*, Z*, ZH, V*, DH,
            // J*, B*, D*, G*, GX>
        ...
        // WH, R*, L*, W*, Y*, M*, N*, NX, Q*, Z*, ZH, V*, DH, J*, B*, D*, G*,
        // GX
